...
:	LLFloater(),
	mOrder(order)
{
	LLUICtrlFactory::getInstance()->buildFloater(this, "os_floater_inventory_backup_settings.xml");
}
	...
	mBusy(0)
{
	...
	LLUICtrlFactory::getInstance()->buildFloater(this, "os_floater_inventory_backup.xml");
}
