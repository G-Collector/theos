...
public:
	...
	void drawMarker(const LLVector3d& pos_global, const LLColor4& color, BOOL type = FALSE); //Mouselook distance
protected:
	LLTracker();
	~LLTracker();
	...
	//void drawMarker(const LLVector3d& pos_global, const LLColor4& color);//Mouselook distance
