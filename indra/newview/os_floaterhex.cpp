...
#include "os_inventorybackup.h" // for downloading
...
:	LLFloater()
{
	...
	LLUICtrlFactory::getInstance()->buildFloater(this, "os_floater_hex.xml");
}
...
void wearable_callback(LLViewerWearable* old_wearable, void* userdata)
{
